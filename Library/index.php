...
<div class="tabbable" style="background: white; border-radius:6px; padding: 2px;"> <!-- Only required for left/right tabs -->
  ...
  <div class="tab-content" style="padding: 5px;">
    <div class="tab-pane active" id="tab1">
      <!--Welcome-->
      <div class="hero-unit">
        <h2>Selamat Datang Kembali <?php $nm=explode(" ",$_SESSION['nama']); echo $nm[0];  ?> !</h2>
        <p>Selamat Datang di Program Perpustakaan </p>
        <p>
    ...
    <!--peminjam aktif-->
     <table class="table table-striped table-hover" width='100%' cellpadding='2' cellspacing='1' style='font-size: 12px; border: 1px inset;'><!--Tabel anak2--> 
        ...
        <?php $i='1'; $ab=mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM tbl_anggota WHERE count !='0' AND kelas NOT LIKE 'Alumni%' ORDER BY count DESC limit 0,50"); while($cde=mysqli_fetch_array($ab)){ ?>
            <tr>
                <td><?php echo $i; ?></td>
    ...
    <!--buku populer-->
       <table  class="table table-striped table-hover" width='100%' cellpadding='2' cellspacing='1' border='0' style='border: 1px inset;' id='popl'><!--Tabel anak-->
        ...
        <?php $popu=mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM tbl_buku WHERE count != '0' ORDER BY count DESC LIMIT 0,50"); $no='1'; while($pop=mysqli_fetch_array($popu)){ ?>
            <tr id='pop'>
                <td><?php echo $no; ?></td>
