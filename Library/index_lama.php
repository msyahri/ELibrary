...
<table width='100%' cellpadding='2' cellspacing='2' border='0'><!--Tabel Induk-->
    <tr>
        <td width='50%'><b>Buku Top 50</b>
            ...
            <?php $popu=mysqli_query($GLOBALS["___mysqli_ston"], "select * from buku where count_pinjam != '0' order by count_pinjam DESC limit 0,50"); $no='1'; while($pop=mysqli_fetch_array($popu)){ ?>
                <tr id='pop'>
        ...
        <td valign='top'><b>Peminjam Aktif</b>
            <table width='100%' cellpadding='2' cellspacing='1' style='background-color: #FFFF99; font-size: 12px;'><!--Tabel anak2--> 
                ...
                <?php $i='1'; $ab=mysqli_query($GLOBALS["___mysqli_ston"], "select * from siswa where count_pinjam !='0' order by count_pinjam DESC limit 0,50"); while($cde=mysqli_fetch_array($ab)){ ?>
