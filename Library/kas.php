...
if(isset($_POST['tombol']) && isset($_SESSION['nama'])){
    $val=mysqli_real_escape_string($GLOBALS["___mysqli_ston"], $_POST['val']);
    $ket=mysqli_real_escape_string($GLOBALS["___mysqli_ston"], $_POST['ket']);
    $type=$_POST['jenis'];
    $skg=date('Y-m-d');
    ...
    mysqli_query($GLOBALS["___mysqli_ston"], "INSERT INTO tbl_kas SET $type = '$val', tgl = '$skg', ket='$ket', saldo='$saldo'");
}
?>
