...
function kep($kep, $hr, $bul, $thn){
    $q=mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM tbl_peminjaman WHERE tgl_pinjam LIKE '%$hr' AND buku LIKE '$kep%' AND tgl_pinjam LIKE '%-$bul-%' AND tgl_pinjam LIKE '$thn%'");
